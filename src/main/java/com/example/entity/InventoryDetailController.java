...
@RestController
@RequestMapping(path = { "/", "/api/inventoryDetails" })
public class InventoryDetailController extends PosController<InventoryDetail, Long> {

	private final InventoryDetailService service;
