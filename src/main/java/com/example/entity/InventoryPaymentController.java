...
@RestController
@RequestMapping(path = { "/", "/api/inventoryPayments" })
public class InventoryPaymentController extends PosController<InventoryPayment, Long> {

	private final InventoryPaymentService service;
